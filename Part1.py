...
Original file is located at
    https://colab.research.google.com/drive/11GwE19ruJZiG8Lq4cXiN_pBAEgiofZE-
...
def display_tensor(image_tensor, num_images=32, size=(3, 150, 150)):
...
#Reference: https://github.com/rosinality/style-based-gan-pytorch
...
class Discriminator(nn.Module):
    ...
    def load_VGG-16(img, gender_output_A):
      ...
      model = load_model(model_folder+'/model_vgg (2)')
